...
<body bgcolor="#EEFDEF">
<div align="center">
<h1>VARIOUS BOOKS ON DATA BASES.....</h1>
</div>
	...
	$query='database';
        ...
        if(mysqli_num_rows($raw_results) > 0){ // if one or more rows are returned do following
            ...
            while($results = mysqli_fetch_array($raw_results,MYSQLI_ASSOC))
			{
              ...
              <img src="dbs/<?php echo $results['file']?>">
              </td>
              <td>
              <?php
             ...
             ?>
              ...
              <br><a style='text-decoration:none;' href="Req.php?id=<?php echo $results['ser_no']?>"> <button id=\"sharan\">Request</button></a><br><br><br>
              </td>
              </tr>
